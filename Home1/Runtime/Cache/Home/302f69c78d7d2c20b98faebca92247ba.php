    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                    ...
                    <?php $__FOR_START_2838__=0;$__FOR_END_2838__=count($banners);for($i=$__FOR_START_2838__;$i < $__FOR_END_2838__;$i+=1){ if($banner1 == $banners[$i]): ?><option selected="selected"><?php echo ($banner1); ?></option>
                        <?php else: ?>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                    ...
                    <?php $__FOR_START_1291__=0;$__FOR_END_1291__=count($banners);for($i=$__FOR_START_1291__;$i < $__FOR_END_1291__;$i+=1){ if($banner2 == $banners[$i]): ?><option selected="selected"><?php echo ($banner2); ?></option>
                        <?php else: ?>
                        <option><?php echo ($banners[$i]); ?></option><?php endif; } ?>
                    </select>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                    ...
                    <?php $__FOR_START_30993__=0;$__FOR_END_30993__=count($banners);for($i=$__FOR_START_30993__;$i < $__FOR_END_30993__;$i+=1){ if($banner3 == $banners[$i]): ?><option selected="selected"><?php echo ($banner3); ?></option>
                        <?php else: ?>
                        <option><?php echo ($banners[$i]); ?></option><?php endif; } ?>
                    </select>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-8" align="center">
                    ...
                    <?php $__FOR_START_12607__=0;$__FOR_END_12607__=count($banners);for($i=$__FOR_START_12607__;$i < $__FOR_END_12607__;$i+=1){ if($banner4 == $banners[$i]): ?><option selected="selected"><?php echo ($banner4); ?></option>
                        <?php else: ?>
                        <option><?php echo ($banners[$i]); ?></option><?php endif; } ?>
                    </select>
